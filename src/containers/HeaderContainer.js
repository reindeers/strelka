        ...
        return(
          ...
          <video poster="https://s3-us-west-2.amazonaws.com/s.cdpn.io/4273/polina.jpg" id="bgvid" playsInline autoPlay muted loop>
              ...
              (<div className="menu__header">
                  ...
                  <button className="menu__start_button">Начать обучение</button><button className="menu__play_button" onClick={(e) => this.handleClick(e)}>go</button><span>Посмотреть видео</span>
              </div>)}
